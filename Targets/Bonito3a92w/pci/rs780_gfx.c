...
//	pci_write_config32(nb_dev, 0x90, 0xf0000000);
 ...
 //   pci_write_config32(nb_dev,0x90,0x90000000);
	...
	/* Change the freq. to 533 MHz. by wanghonghu */
	/* MC_MPLL_CONTROL2. */
//	nbmc_write_index(nb_dev, 0x07, 0x40110478); //533

//	nbmc_write_index(nb_dev, 0x07, 0x40224498);  //333
	nbmc_write_index(nb_dev, 0x07, 0x40000018);  //400
	/* MC_MPLL_DIV_CONTROL. */
//	nbmc_write_index(nb_dev, 0x0b, 0x00000478);   //533
//	nbmc_write_index(nb_dev, 0x0b, 0x00004498); //333
	nbmc_write_index(nb_dev, 0x0b, 0x00000018); //400
