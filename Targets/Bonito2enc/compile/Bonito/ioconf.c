...
/*  3: pci* at pcibr0 bus -1 */
    {&pci_ca,		&pci_cd,	 0, STAR, loc+  1,    0, pv+ 4, 1, 0,    0},
/*  4: fxp0 at pci* dev -1 function -1 */
    {&fxp_ca,		&fxp_cd,	 0, NORM, loc+  0,    0, pv+ 0, 3, 0,    0},
/*  5: rtl* at pci* dev -1 function -1 */
    {&rtl_ca,		&rtl_cd,	 0, STAR, loc+  0,    0, pv+ 0, 3, 0,    0},
...
/*  8: ide_cd* at pciide* channel -1 drive -1 */
