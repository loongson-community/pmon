...
int cmd_wrprom_em0(int ac,char **av)
{
	...
	unsigned short rom[EEPROM_CHECKSUM_REG+1]={
			...
			0xaa00, 0x0100, 0x0302, 0x0634, 0xf746, 0x0000, 0x0000, 0x0000,
			0x3412, 0x0356, 0x0e6b, 0x0000, 0x8086, 0x10d3, 0x0000, 0x0558,
			0x0000, 0xff01, 0x7e04, 0x0000, 0x0000, 0x00a8, 0x0000, 0x0704,
			0x6cc9, 0x2150, 0x070e, 0x4503, 0x2d80, 0x0000, 0x4300, 0x0000,
			0xff00, 0x0000, 0x0f04, 0x7fff, 0x6801, 0x0000, 0x0000, 0x2000,
