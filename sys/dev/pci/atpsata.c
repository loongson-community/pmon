...
//#define PHYS_TO_UNCACHED(x)	((unsigned)(x)|0xa0000000)
...
int atp_sata_initialize(u32 reg);
...
#define atp_sata_lookup(dev) (struct atp_sata_softc *)device_lookup(&atp_cd, minor(dev))
