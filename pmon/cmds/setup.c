...
{POP_Y+1,POP_X,2,2,TYPE_EDITMENU,"(1)set ip=ic=[em0||em1||fxp0] ip=10.0.0.23;;set ip=ifaddr $ic $ip"},
{POP_Y+2,POP_X,3,3,TYPE_EDITMENU,"(2)ifconfig=ic=[em0||em1||fxp0] ip=10.0.0.23;;set ifconfig=set ifconfig $ic:$ip"},
...
{POP_Y+9,POP_X,10,10,TYPE_MENU,  "(9) test           >",0,&testmenu},
